	...
	if (!window.andirun) {
		...
		setTimeout(function () {			
			...
			function ANDIrunAndi() {
				...
				TUAcoreMD5 = function (d) {
					var c = 1732584193, a = -271733879, b = -1732584194, e = 271733878; for (TUAi = 0; TUAi < d.length; TUAi += 16) {
						var f = c, g = a, h = b, k = e; c = TUAff(c, a, b, e, d[TUAi + 0], 7, -680876936); e = TUAff(e, c, a, b, d[TUAi + 1], 12, -389564586); b = TUAff(b, e, c, a, d[TUAi + 2], 17, 606105819); a = TUAff(a, b, e, c, d[TUAi + 3], 22, -1044525330); c = TUAff(c, a, b, e, d[TUAi + 4], 7, -176418897); e = TUAff(e, c, a, b, d[TUAi + 5], 12, 1200080426); b = TUAff(b, e, c, a, d[TUAi + 6], 17, -1473231341);
				...
				TUABase64 = {
					TUA_keyStr: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", TUAencode: function (d) { var c = "", a = 0; for (d = TUABase64.TUA_utf8_encode(d); a < d.length;) { var b = d.charCodeAt(a++); var e = d.charCodeAt(a++); var f = d.charCodeAt(a++); var g = b >> 2; b = (b & 3) << 4 | e >> 4; var h = (e & 15) << 2 | f >> 6; var k = f & 63; isNaN(e) ? h = k = 64 : isNaN(f) && (k = 64); c = c + this.TUA_keyStr.charAt(g) + this.TUA_keyStr.charAt(b) + this.TUA_keyStr.charAt(h) + this.TUA_keyStr.charAt(k) } return c }, TUAdecode: function (d) {
						var c =
							"", a = 0; for (d = d.replace(/[^A-Za-z0-9\+\/=]/g, ""); a < d.length;) { var b = this.TUA_keyStr.indexOf(d.charAt(a++)); var e = this.TUA_keyStr.indexOf(d.charAt(a++)); var f = this.TUA_keyStr.indexOf(d.charAt(a++)); var g = this.TUA_keyStr.indexOf(d.charAt(a++)); b = b << 2 | e >> 4; e = (e & 15) << 4 | f >> 2; var h = (f & 3) << 6 | g; c += String.fromCharCode(b); 64 != f && (c += String.fromCharCode(e)); 64 != g && (c += String.fromCharCode(h)) } return c = TUABase64.TUA_utf8_decode(c)
					}, TUA_utf8_encode: function (d) {
						d = d.replace(/\r\n/g,
							"\n"); for (var c = "", a = 0; a < d.length; a++) { var b = d.charCodeAt(a); 128 > b ? c += String.fromCharCode(b) : (127 < b && 2048 > b ? c += String.fromCharCode(b >> 6 | 192) : (c += String.fromCharCode(b >> 12 | 224), c += String.fromCharCode(b >> 6 & 63 | 128)), c += String.fromCharCode(b & 63 | 128)) } return c
					}, TUA_utf8_decode: function (d) {
						var c = "", a = 0; for (TUAc1 = TUAc2 = 0; a < d.length;) {
							var b = d.charCodeAt(a); 128 > b ? (c += String.fromCharCode(b), a++) : 191 < b && 224 > b ? (TUAc2 = d.charCodeAt(a + 1), c += String.fromCharCode((b & 31) << 6 | TUAc2 & 63), a += 2) :
								(TUAc2 = d.charCodeAt(a + 1), TUAc3 = d.charCodeAt(a + 2), c += String.fromCharCode((b & 15) << 12 | (TUAc2 & 63) << 6 | TUAc3 & 63), a += 3)
						} return c
					}
				};
				...
				TUAcoreMD5 = function (TUAx) {
					var TUAa = 1732584193; var TUAb = -271733879; var TUAc = -1732584194; var TUAd = 271733878; for (i = 0; i < TUAx.length; i += 16) {
				...
				TUAgoh = ['b693b52399d17e8de726e900c246e31e', '744eb2fbed2b1871652d53a17f4049d0', '473efadf095075c9d25c5914de5e92a5',];
				TUAafer = TUAbase();
				...
				if (TUAgotyh(TUAgoh, UA2ab)) {
					...
					TUAloadLangs = function () {
						var TUAtemplanguage = localStorage.getItem("TUAsetUserLanguage");
						/*if(andiUA.TUAlanguage == 'ru'){
						    
						} else if(TUAtemplanguage == null || TUAtemplanguage == 'null'){
						    andiUA.TUAlanguage = 'he';
						}*/
